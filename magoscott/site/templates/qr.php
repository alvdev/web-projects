...
<body class="debug-screens font-sans bg-indigo-950 text-white">
    <div class="h-full flex flex-col min-h-screen bg-linear-to-tl from-indigo-950 via-indigo-950 via-50% to-black">
        <main class="relative md:w-sm md:mx-auto px-2">
            <div
                 class="px-4 min-h-52 flex flex-col justify-center *:[a]:text-base *:[a]:text-fuchsia-300 *:[a]:focus:text-fuchsia-400 *:[a]:font-sans">
                <?php if ($page->website()): ?>
                <img src="<?= asset('assets/images/logo_scott.png')->url() ?>"
                     alt="Logo Mago Scott"
                     class="w-24 h-auto">
                <?php endif; ?>

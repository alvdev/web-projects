...
<main class="bg-linear-to-tl from-indigo-950 via-indigo-950 via-50% to-black">
    <article class="container w-11/12 md:w-10/12 lg:w-4/5 xl:w-3/5 pt-28 md:pt-44 lg:pt-48 xl:pt-56">
        <div class="relative pl-4 md:pl-8 before:absolute before:left-0 before:w-0.5 md:before:w-1 before:h-full before:bg-red-600 before:rounded-full">
            <div class="absolute w-14 md:w-full -left-7 md:-left-12.5 -top-4 *:border-3 md:*:border-4 *:border-red-600 *:rounded-full *:shadow-[0_0_50px_rgb(255_255_255/30%)]">
            ...
            <?php if ($summary = $page->summary()): ?>
                <div class="mt-4 md:mt-8 *:text-xl md:*:text-2xl lg:*:text-3xl text-white/80"><?= $summary ?></div>
            <?php endif ?>
        </div>
        ...
        <div class="relative mt-16 min-w-full prose prose-p:text-lg md:prose-p:text-xl lg:prose-p:text-2xl font-light text-pretty pl-4 md:pl-8 text-white/90 before:absolute before:left-0 before:w-0.5 md:before:w-1 before:h-full before:bg-red-600 before:rounded-full">
            <?= $page->text()->toBlocks() ?>
        </div>
    </article>
</main>

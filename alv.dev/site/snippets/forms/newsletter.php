...
if ($isDark) {
    $classes .= '**:[input]:border-green-500 **:[button]:bg-green-500 **:[button]:text-black';
} else {
    $classes .= '**:[input]:border-black **:[button]:bg-black **:[button]:text-green-500';
}
...
snippet('dreamform/form', [
    ...
    'attr' => [
        ...
        'button' => ['class' => 'rounded-xs inline-block w-fit min-w-[50%] px-8 py-2 mt-4 hover:animate-wiggle'],

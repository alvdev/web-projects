...
snippet('dreamform/form', [
    ...
    'attr' => [
        ...
        'input' => ['class' => 'w-full bg-transparent border-b-2 border-green-500 text-green-500 placeholder:text-green-100 placeholder:font-light pb-2 outline-none peer group-data-[has-error]:placeholder:text-white group-data-[has-error]:mb-2 shadow-sm group-data-[has-error]:placeholder-shown:border-rose-400'],
        'button' => ['class' => 'bg-green-500 rounded text-black inline-block w-fit min-w-[50%] px-8 py-2 mt-4 hover:animate-wiggle'],

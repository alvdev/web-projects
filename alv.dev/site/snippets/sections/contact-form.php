<section class="bg-emerald-100 bg-opacity-90 backdrop-blur-lg py-28 border-t-2 border-white" id="contact">
    <div class="container flex gap-24">
        <div class="w-2/5">
            <div class="font-bold leading-none flex flex-wrap flex-col gap-y-2 mb-10">
                <span class="text-emerald-800 text-xl">Contacto</span>
                <h3 class="text-black-800 text-4xl lg:text-5xl xl:text-[64px] tracking-[-1.5px]">
                    <span class="relative z-[1] before:rounded-full before:bg-primary before:block before:absolute before:top-[4px] before:left-[-6px] before:-z-[1] before:w-[36px] lg:before:w-[48px] xl:before:w-[64px] before:h-[36px] lg:before:h-[48px] xl:before:h-[64px]">Siempre contesto
                </h3>
            </div>
            ...
            <div class="flex flex-wrap flex-col gap-7">
                <div class="flex flex-wrap gap-4 pb-4 border-b border-gray-300 lg:max-w-[416px]">
                    ...
                    <div class="flex flex-wrap flex-col flex-1">
                        <span class="paragraph !leading-none">Puedes escribirme a</span>
                        <h5 class="text-xl font-bold text-black-800 leading-7">soy@alv.dev
                        </h5>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap gap-4 pb-4 border-b border-gray-300 lg:max-w-[416px]">
                    ...
                    <div class="flex flex-wrap flex-col flex-1">
                        <span class="paragraph !leading-none">Chatear conmigo en</span>
                        <a class="link-green-xl" href="https://t.me/alvdev" target="_blank">t.me/alvdev
                        </a>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap gap-4 pb-4 border-b border-gray-300 lg:max-w-[416px]">
                    ...
                    <div class="flex flex-wrap flex-col flex-1">
                        <span class="paragraph !leading-none">O seguirme en</span>
                        <h5 class="link-blue-xl" href="https://www.linkedin.com/in/alvdev" target="_blank">linkedin.com/in/alvdev
                        </h5>
                    </div>
                </div>
            </div>
        ...
        <div class="w-3/5">
            <form id="contact-form" action="mail.php" method="post" class="grid grid-cols-12 gap-[18px]">
                <div class="col-span-12 md:col-span-6">
                    ...
                    <input id="name" class="w-full border-3 border-emerald-200 rounded-lg p-4 focus:border-emerald-400 outline-none transition-all" type="text" required="" placeholder="Your name*" name="name">
                </div>
                <div class="col-span-12 md:col-span-6">
                    <label class="text-sm font-normal font-Inter leading-tight mb-3 block" for="Email">Email</label>
                    <input id="Email" class="w-full border-3 border-emerald-200 rounded-lg p-4 focus:border-emerald-400 outline-none transition-all" type="email" required="" placeholder="Your email*" name="email">
                </div>
                <div class="col-span-12 md:col-span-6">
                    <label class="text-sm font-normal font-Inter leading-tight mb-3 block" for="Phone">Phone</label>
                    <input id="Phone" class="w-full border-3 border-emerald-200 rounded-lg p-4 focus:border-emerald-400 outline-none transition-all" type="text" required="" placeholder="Your number" name="phone">
                </div>
                <div class="col-span-12 md:col-span-6">
                    <label class="text-sm font-normal font-Inter leading-tight mb-3 block" for="Subject">Subject*</label>
                    <input id="Subject" class="w-full border-3 border-emerald-200 rounded-lg p-4 focus:border-emerald-400 outline-none transition-all" type="text" required="" placeholder="Your subject*" name="subject" spellcheck="false" data-ms-editor="true">
                </div>

                <div class="col-span-12">
                    <label class="text-sm font-normal font-Inter leading-tight mb-3 block" for="Message">Message</label>
                    <textarea class="w-full h-28 border-3 border-emerald-200 rounded-lg p-4 focus:border-emerald-400 outline-none transition-all resize-none" name="message" id="Message" cols="30" rows="10" required="" placeholder="Type your message" spellcheck="false" data-ms-editor="true"></textarea>
                </div>

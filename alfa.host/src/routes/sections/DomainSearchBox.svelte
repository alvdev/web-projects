...
<section class="flex flex-col items-center px-8 py-12 mb-16 bg-gray-200 lg:flex-row gap-x-8 gap-y-4">
            <h3 class="relative text-lg font-medium text-center uppercase md:w-full lg:w-2/5">
                Todo emprendedor digital necesita un
                dominio donde crear su negocio online
                <span class="hidden md:block md:absolute md:z-10 md:w-32">
                    <svg version="1.1" class="" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 392.652 392.652"
            ...
            <div class="w-full lg:w-3/5">
                <form class="flex flex-col justify-around w-full gap-2 sm:flex-row" action="./">
                    ...
                    <button class=" w-full p-4 text-white uppercase bg-black rounded shadow-md hover:shadow-inner">

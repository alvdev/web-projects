        ...
        <div>
            ...
            <nav class="grid items-center justify-between grid-cols-2 py-6 lg:flex lg:px-8 lg:gap-4">
                <div class="pl-8 logo md:pl-0">
                    <svg class="w-auto lg:w-26 xl:w-auto" xmlns="http://www.w3.org/2000/svg" width="160" height="62"
                        viewbox="0 0 520 200">
                        <defs>
                            <style>
                                .a,
                ...
                <ul
                    ...
                    <li><a href="#" class="p-2 lg:text-white">Blog</a></li>
        ...
        <section class="p-8 mb-8 text-center">
            ...
            <div class="flex flex-col justify-between gap-12 md:flex-row">
                <div class="flex-1 text-center">
                    <div>
                        <svg class="w-2/3 h-40 m-auto" id="e3fcecc7-e6c1-4472-ba1a-540914afc660" data-name="Layer 1"
                            xmlns="http://www.w3.org/2000/svg" width="788.6063" height="505.46457"
                            ...
                            <path
                                ...
                                transform="translate(-205.69685 -197.26772)" fill="#000" />
                            <path
                                ...
                                transform="translate(-205.69685 -197.26772)" fill="#2a63eb" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-205.69685 -197.26772)" fill="#334155" />
                    ...
                    <p>
                        Es el nombre que tendrá tu sitio web, el nombre de
                        tu negocio digital. Sin un dominio nunca emprenderás
                        nada.
                    </p>
                </div>
                <div class="flex-1">
                    <div>
                        <svg class="w-2/3 h-40 m-auto mt-auto" id="aa03ddf9-f8f2-4819-a4ce-be9b0a220741"
	...
	c7.64-4.04,32.98-14.02,77.92,0.42c3.31,1.04,6.27,2.98,8.54,5.6C1093.69,655.95,1095.12,658.66,1094.44,661.53z" />
                    ...
                    <p>
                        El local en Internet en el que colocarás y servirás
                        todo el contenido de tu sitio web a tus visitantes y
                        clientes potenciales.
                    </p>
                </div>
                <div class="flex-1">
                    <div class="flex">
                        <svg class="w-2/3 h-40 mx-auto" id="f0a8f4ba-cc2b-4400-9e08-d246a0bad060" data-name="Layer 1"
                            xmlns="http://www.w3.org/2000/svg" width="1098.75" height="632.37039"
                            ...
                            <circle cx="804.375" cy="157.1852" r="36" fill="#2563eb" opacity="0.3" />
                            ...
                            <rect x="141.09287" y="215.02041" width="22.24232" height="28.59727"
                                transform="translate(244.80285 330.54921) rotate(-177.77929)" fill="#2563eb" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-50.625 -133.8148)" fill="#000" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-50.625 -133.8148)" fill="#2563eb" />
                            <path
                    ...
                    <p>
                        El escaparate y punto de encuentro para todos tus
                        visitantes. Sin un sitio web eres un vendedor
                        ambulante en internet.
                    </p>
                </div>
            </div>
        </section>
        ...
        <section class="p-8 mb-24 text-center">
            ...
            <div class="flex flex-col justify-between gap-12 md:flex-row">
                <div class="flex-1">
                    <div>
                        <svg class="w-2/3 h-40 m-auto" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <path
                                ...
                                transform="translate(-135 -232.85)" fill="#535461" />
                            ...
                            <path
                                ...
                                transform="translate(-135 -232.85)" fill="#2563eb" />
                            <g opacity="0.5">
                                <path
                            ...
                            <path
                                ...
                                transform="translate(-135 -232.85)" fill="#2563eb" opacity="0.5" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-135 -232.85)" fill="#2563eb" opacity="0.3" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-135 -232.85)" fill="none" stroke="#535461" stroke-miterlimit="10"
                            ...
                            <path
                                ...
                                transform="translate(-135 -232.85)" fill="#2563eb" />
                            <path d="M254.24,578.34" transform="translate(-135 -232.85)" fill="none" stroke="#bdbdbd"
                            ...
                            <path
                                ...
                                transform="translate(-296.67 -118.73) rotate(-19.56)" fill="#2563eb" />
                            <path d="M268.12,545.55l-8.89,3.16a11.25,11.25,0,0,1-14.37-6.83h0L264.35,535Z"
                                transform="translate(-135 -232.85)" fill="#4d8af0" />
                            <path
                                ...
                                transform="translate(-135 -232.85)" opacity="0.05" />
                            <path
                                ...
                                transform="translate(-135 -232.85)" fill="#2563eb" />
                            <path d="M267.3,524.71s6.51-1.76,5.24.06l-4.63,1.65Z" transform="translate(-135 -232.85)"
                                fill="#fda57d" />
                            <path d="M270.65,507.88s-.1-5.31,1.47-4.36.86,4.36.86,4.36Z"
                                transform="translate(-135 -232.85)" fill="#fda57d" />
                            ...
                            <path
                                ...
                                transform="translate(-135 -232.85)" fill="#333" />
                            <path
                            ...
                            <rect x="242.97" y="509.07" width="5.17" height="7.76" rx="2.59" ry="2.59"
                                transform="translate(-292.57 -121.03) rotate(-19.56)" fill="#fda57d" />
                            <path
                            ...
                            <circle cx="242.79" cy="505.15" r="8.28"
                                transform="translate(-290.12 -122.41) rotate(-19.56)" fill="#fda57d" />
                            <path
                            ...
                            <ellipse cx="235.56" cy="507.03" rx="0.84" ry="1.68"
                                transform="translate(-291.16 -124.72) rotate(-19.56)" fill="#fda57d" />
                            <path
                    ...
                    <p>
                        Para capturar los emails de tus visitantes y
                        mantener el contacto constante con ellos de una
                        forma automatizada.
                    </p>
                </div>
                <div class="flex-1">
                    <div>
                        <svg class="w-2/3 h-40 m-auto" xmlns="http://www.w3.org/2000/svg" width="821.16801"
                            ...
                            <path
                                ...
                                transform="translate(-189.41599 -106.099)" fill="#000" />
                            <polygon
                            ...
                            <path id="ae5c11dc-7e77-468a-a39f-cc8da6ee1565" data-name="Path 1495"
                                ...
                                transform="translate(-189.41599 -106.099)" fill="#334155" />
                            ...
                            <path id="b32730d1-ac43-40b1-a176-73e18bf362e5" data-name="Path 1515"
                                ...
                                transform="translate(-189.41599 -106.099)" fill="#2a63eb" />
                    ...
                    <p>
                        Para que tu negocio digital nunca deje de crecer
                        apareciendo en las primeras posiciones de buscadores
                        como Google.
                    </p>
                </div>
                <div class="flex-1">
                    <div>
                        <svg class="w-2/3 h-40 m-auto" id="b13b70b1-aa4f-457d-9f62-b44ed99594ac" data-name="Layer 1"
                            xmlns="http://www.w3.org/2000/svg" width="846.02036" height="713.52973"
                            viewbox="0 0 846.02036 713.52973">
                            ...
                            <path
                                ...
                                transform="translate(-176.98982 -93.23513)" fill="#2a63eb" />
                            <path
                                ...
                                transform="translate(-176.98982 -93.23513)" fill="#334155" />
                            <path
                                ...
                                transform="translate(-176.98982 -93.23513)" fill="#f2f2f2" />
                            ...
                            <path
                                ...
                                transform="translate(-176.98982 -93.23513)" fill="#000" />
                            <path
                                ...
                                transform="translate(-176.98982 -93.23513)" fill="#9f616a" />
                            <path
                                d="M716.26275,347.45851s2.78616,10.76072-3.39733,18.38S739.4475,400.6082,739.4475,400.6082l17.28539-2.971s-3.8097-33.064,1.30766-41.43662S716.26275,347.45851,716.26275,347.45851Z"
                                transform="translate(-176.98982 -93.23513)" opacity="0.1" />
                            <polygon
                            ...
                            <path
                                ...
                                transform="translate(-176.98982 -93.23513)" fill="#000" />
                            <circle cx="564.40495" cy="242.41068" r="33.23151" fill="#9f616a" />
                            <path
                                ...
                                transform="translate(-176.98982 -93.23513)" fill="#d0cde1" />
                            <path
                    ...
                    <p>
                        Para generar una gran imagen de marca y atraer
                        clientes de los medios sociales elevando su
            ...
            <div class="grid justify-between grid-cols-2 gap-4 md:grid-cols-5">
                <div class="uppercase border rounded">
                    <div class="p-8 m-auto text-blue-800 bg-gray-200 fill-current ">
                        <svg class="w-20 h-20 m-auto" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewbox="0 0 72 90"
                ...
                <div class="uppercase border rounded">
                    <div class="p-8 m-auto text-blue-800 bg-gray-200 fill-current ">
                        <svg class="w-20 h-20 m-auto" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 72 90">
                            ...
                            <path d="M12,35.46a.76.76,0,0,0,.75-.75V32.8a.75.75,0,0,0-1.5,0v1.91A.74.74,0,0,0,12,35.46Z"
                                transform="translate(-6.29 -4.25)" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-6.29 -4.25)" />
                            <path d="M25,35.46a.76.76,0,0,0,.75-.75V32.8a.75.75,0,0,0-1.5,0v1.91A.75.75,0,0,0,25,35.46Z"
                                transform="translate(-6.29 -4.25)" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-6.29 -4.25)" />
                            <path d="M12,54.11a.76.76,0,0,0-.75.75v1.91a.75.75,0,0,0,1.5,0V54.86A.76.76,0,0,0,12,54.11Z"
                                transform="translate(-6.29 -4.25)" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-6.29 -4.25)" />
                            <path d="M25,54.11a.76.76,0,0,0-.75.75v1.91a.75.75,0,1,0,1.5,0V54.86A.76.76,0,0,0,25,54.11Z"
                                transform="translate(-6.29 -4.25)" />
                            <path d="M12,59.94a.76.76,0,0,0-.75.75V62.6a.75.75,0,0,0,1.5,0V60.69A.75.75,0,0,0,12,59.94Z"
                                transform="translate(-6.29 -4.25)" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-6.29 -4.25)" />
                            <path d="M25,59.94a.76.76,0,0,0-.75.75V62.6a.75.75,0,0,0,1.5,0V60.69A.75.75,0,0,0,25,59.94Z"
                                transform="translate(-6.29 -4.25)" />
                            <path
                ...
                <div class="uppercase border rounded">
                    <div class="p-8 m-auto text-blue-800 bg-gray-200 fill-current ">
                        <svg class="w-20 h-20 m-auto php" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="uppercase border rounded">
                    ...
                    <div class="p-4">
                        <strong>Estadísticas web avanzadas</strong>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="px-8 py-24 mb-24 bg-gray-200">
            ...
            <div class="grid gap-8 md:grid-cols-2">
                <div class="flex flex-col justify-center gap-6 p-8 bg-white rounded shadow-sm xl:flex-row xl:gap-4">
                    <div>
                        <svg class="w-40 m-auto" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="100%"
                            height="100%" viewbox="0 0 1099 797.68034">
                            ...
                            <path
                                ...
                                transform="translate(-50.5 -51.15983)" fill="#2f2e41" />
                            <path
                                ...
                                transform="translate(-50.5 -51.15983)" fill="#ffb9b9" />
                            <path
                                d="M893.17509,498.69674s6.74118,23.59415-5.05589,25.27945a46.05232,46.05232,0,0,0-20.22356,8.42648l21.90885,28.65h40.44712l25.27946-25.27945s-33.70594-25.27945-26.96475-40.44712S893.17509,498.69674,893.17509,498.69674Z"
                                transform="translate(-50.5 -51.15983)" opacity="0.1" />
                            <polygon
                            ...
                            <path
                                ...
                                transform="translate(-50.5 -51.15983)" fill="#575a89" />
                            <path
                            ...
                            <path
                                d="M845.98678,709.35883s-32.02064,43.81771-8.42649,55.61479,136.509,11.79708,144.93552,0,11.79708-48.8736,0-52.2442S845.98678,709.35883,845.98678,709.35883Z"
                                transform="translate(-50.5 -51.15983)" opacity="0.2" />
                            ...
                            <path
                                ...
                                transform="translate(-50.5 -51.15983)" fill="#2563eb" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-50.5 -51.15983)" fill="none" stroke="#000" stroke-miterlimit="10"
                            ...
                            <path
                                ...
                                transform="translate(-50.5 -51.15983)" fill="#3f3d56" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-50.5 -51.15983)" fill="#9f616a" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-50.5 -51.15983)" fill="#d0cde1" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-50.5 -51.15983)" fill="#2f2e41" />
                            <path d="M237.5596,498.96463s-3.98019,115.12729-6.33712,118.66268,0-119.02457,0-119.02457Z"
                                transform="translate(-50.5 -51.15983)" opacity="0.1" />
                            <path
                            ...
                            <rect x="265.76827" y="279.2544" width="35" height="65.22365"
                                transform="translate(-148.0884 80.56853) rotate(-22.43787)" fill="#2f2e41" />
                            ...
                            <ellipse cx="548.27911" cy="285.58651" rx="17" ry="9"
                                transform="translate(-96.53536 64.25047) rotate(-11.53546)" fill="none" stroke="#3f3d56"
                                stroke-miterlimit="10" stroke-width="2" />
                            ...
                            <ellipse cx="545.93796" cy="343.07113" rx="9" ry="17"
                                transform="translate(115.2961 812.71667) rotate(-86.0194)" fill="none" stroke="#3f3d56"
                                stroke-miterlimit="10" stroke-width="2" />
                    ...
                    <div>
                        ...
                        <p>
                            Nuestro programa de afiliados no es como el
                            resto. Cada afiliado que recomienda nuestros
                            servicios es porque es cliente, no es alguien
                            que promociona nuestros servicios sin
                            conocerlos.
                        </p>
                    </div>
                </div>
                <div class="flex flex-col justify-center gap-6 p-8 bg-white rounded shadow-sm xl:flex-row xl:gap-4">
                    <div>
                        <svg class="w-40 m-auto" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="100%"
                            height="100%" viewbox="0 0 987.58708 714.02784">
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-106.20646 -92.98608)" fill="#2563eb" />
                            <path
                    ...
                    <div>
                        ...
                        <p>
                            Quieres convertirte en un empresario digital, no
                            puedes estar sólo. Nos preocupamos por ti, por
                            tu estado de ánimo. Compartimos las inquietudes
                            y preocupaciones que sufre un emprendedor
                            digital.
                        </p>
                    </div>
                </div>
                <div class="flex flex-col justify-center gap-6 p-8 bg-white rounded shadow-sm xl:flex-row xl:gap-4">
                    <div>
                        <svg class="w-40 mx-auto" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="100%"
                            height="100%" viewbox="0 0 901.99951 702.00734">
                            ...
                            <path
                                ...
                                transform="translate(-171.00024 -88.99633)" fill="#2563eb" />
                            <path
                    ...
                    <div>
                        ...
                        <p>
                            Ofrecemos 15 días desde el vencimiento de tus
                            facturas para abonarlas sin suspender el
                            servicio. Y si decides no pagarlas, nadie te
                            meterá en ninguna lista de morosos como otras
                            empresas.
                        </p>
                    </div>
                </div>
                <div class="flex flex-col justify-center gap-6 p-8 bg-white rounded shadow-sm xl:flex-row xl:gap-4">
                    <div>
                        <svg class="w-40 mx-auto" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="100%"
                            height="100%" viewbox="0 0 892.6139 540.80203">
                            ...
                            <path
                                ...
                                transform="translate(-153.69305 -179.59899)" fill="#2563eb" />
                    ...
                    <div>
                        ...
                        <p>
                            Trabajamos cada día de manera permanente para
                            mantener tu sitio web online el 100% del tiempo,
                            pudiendo garantizarte un servicio prácticamente
                            sin interrupciones.
                        </p>
                    </div>
                </div>
                <div class="flex flex-col justify-center gap-6 p-8 bg-white rounded shadow-sm xl:flex-row xl:gap-4">
                    <div>
                        <svg class="w-40 mx-auto" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="100%"
                            height="100%" viewbox="0 0 961.84535 436.79521">
                            ...
                            <path
                                ...
                                transform="translate(-116.15465 -202)" fill="#2563eb" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-116.15465 -202)" fill="#3f3d56" />
                            ...
                            <path
                                ...
                                transform="translate(-116.15465 -202)" fill="#ffb8b8" />
                            <path
                                ...
                                transform="translate(-116.15465 -202)" fill="#d0cde1" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-116.15465 -202)" fill="#2f2e41" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-116.15465 -202)" fill="#a0616a" />
                            <path
                    ...
                    <div>
                        ...
                        <p>
                            Nuestras puertas siempre están abiertas, siempre
                            estamos alerta y nunca nos olvidamos de ti. Pide
                            ayuda a las 3:00 am la noche de año nuevo y la
                            tendrás. Es parte de nuestro compromiso contigo.
                        </p>
                    </div>
                </div>
                <div class="flex flex-col justify-center gap-6 p-8 bg-white rounded shadow-sm xl:flex-row xl:gap-4">
                    <div>
                        <svg class="w-40 mx-auto" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div>
                        ...
                        <p>
                            No sólo velamos por el buen funcionamiento de
                            tus servicios contratados, además hacemos un
                            seguimiento constante de tu negocio digital para
                            ayudarte a mejorarlo y seguir creciendo.
                        </p>
                    </div>
                </div>
                <div class="flex flex-col justify-center gap-6 p-8 bg-white rounded shadow-sm xl:flex-row xl:gap-4">
                    <div>
                        <svg class="w-40 mx-auto" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="100%"
                            height="100%" viewbox="0 0 743.40429 753.13373">
                            ...
                            <path
                                ...
                                transform="translate(-228.29785 -73.43313)" fill="#f2f2f2" />
                            <path
                                ...
                                transform="translate(-228.29785 -73.43313)" fill="#3f3d56" />
                            <path
                                d="M955.20863,737.06376c0,32.26235-151.72264,89.50311-338.882,89.50311s-321.118-115.99853-321.118-148.26087,133.95866,31.42857,321.118,31.42857S955.20863,704.80141,955.20863,737.06376Z"
                                transform="translate(-228.29785 -73.43313)" opacity="0.1" />
                            <path
                            ...
                            <g opacity="0.7">
                                <path
                                    ...
                                    transform="translate(-228.29785 -73.43313)" fill="#2563eb" />
                                <path
                            ...
                            <path
                                ...
                                transform="translate(-228.29785 -73.43313)" fill="#ff6584" />
                            <path
                            ...
                            <ellipse cx="834.95809" cy="269.88867" rx="17.51279" ry="14.594"
                                ...
                                opacity="0.4" />
                            <line x1="548.67563" y1="317.585" x2="519.27091" y2="440.8851" fill="none" stroke="#2f2e41"
                                stroke-miterlimit="10" stroke-width="2" />
                            <g opacity="0.8">
                                <path
                            ...
                            <path
                                ...
                                transform="translate(-228.29785 -73.43313)" fill="#ffb9b9" />
                            <path
                                d="M626.60927,447.61614,616.41655,469.0459s-8.30778,28.788,1.10579,31.8654,11.25109-29.542,11.25109-29.542l7.79675-21.6001Z"
                                transform="translate(-228.29785 -73.43313)" opacity="0.1" />
                            <polygon
                            ...
                            <path
                                ...
                                transform="translate(-228.29785 -73.43313)" fill="#2f2e41" />
                            <path
                                d="M632.29965,519.88653s7.51953,77.34377,19.33594,102.05081,22.5586,92.38284,27.9297,93.45706,46.19142-6.44531,51.56251-10.74219-36.52345-108.49613-36.52345-109.57035-9.668-96.67972-9.668-96.67972l-12.89063-21.48438Z"
                                transform="translate(-228.29785 -73.43313)" opacity="0.1" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-228.29785 -73.43313)" fill="#d0cde1" />
                            <path
                            ...
                            <ellipse cx="697.27112" cy="283.17697" rx="5.47558" ry="2.05334"
                                transform="translate(2.919 800.6496) rotate(-73.83988)" fill="#ffb9b9" />
                            <path
                    ...
                    <div>
                        ...
                        <p>
                            Si en 30 días no cumplimos con tus expectativas,
                            detectas un fallo grave o un problema
                            importante, o simplemente decides que iWolf
                            Hosting no es para ti, te devolvemos el dinero
                            sin excusas.
                        </p>
                    </div>
                </div>
                <div class="flex flex-col justify-center gap-6 p-8 bg-white rounded shadow-sm xl:flex-row xl:gap-4">
                    <div>
                        <svg class="w-40 mx-auto" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <defs>
                                <lineargradient id="fb6415c1-f574-4dab-bb02-7ceb0a7d0718" x1="596" y1="757.78" x2="596"
                                    y2="598.14" gradientunits="userSpaceOnUse">
                                    <stop offset="0" stop-color="gray" stop-opacity="0.25" />
                                    <stop offset="0.54" stop-color="gray" stop-opacity="0.12" />
                                    <stop offset="1" stop-color="gray" stop-opacity="0.1" />
                                </lineargradient>
                            ...
                            <g opacity="0.1">
                                ...
                                <path
                                    ...
                                    transform="translate(-28.5 -118.14)" fill="#3f3d56" />
                            ...
                            <path
                                d="M1171.5,754.36c0,6.87-50.22,13.15-133.25,18-15.1.87-31.28,1.7-48.44,2.48q-22.24,1-46.62,1.89-23.62.84-49.05,1.56c-53.54,1.53-112.73,2.63-175.61,3.18q-22.89.21-46.39.32-24.48.11-49.52.1c-303.14,0-548.87-12.31-548.87-27.5s245.73-27.5,548.87-27.5c130.51,0,250.36,2.29,344.56,6.09l10.3.42h.06C1096.2,738.43,1171.5,746,1171.5,754.36Z"
                                transform="translate(-28.5 -118.14)" opacity="0.15" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-28.5 -118.14)" fill="none" stroke="#3f3d56" stroke-miterlimit="10"
                                stroke-width="4" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-28.5 -118.14)" fill="#fbbebe" />
                            <path
                                ...
                                transform="translate(-28.5 -118.14)" fill="#2f2e41" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-28.5 -118.14)" fill="#e8e8f0" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-28.5 -118.14)" fill="#f86d70" />
                            <path
                            ...
                            <ellipse cx="662.61" cy="637.73" rx="2.08" ry="2.77"
                                transform="translate(-279.29 412.54) rotate(-37.22)" fill="#fbbebe" />
                            <path
                    ...
                    <div>
                        ...
                        <p>
                            ¿Cuánto vale contar con alguien más preocupado
                            por tu negocio digital que tus propios
                            empleados? La atención que recibirás hace que
                            cualquiera de nuestros servicios tengan un
                            precio ridículo.
                        </p>
                    </div>
                </div>
                <div class="flex flex-col justify-center gap-6 p-8 bg-white rounded shadow-sm xl:flex-row xl:gap-4">
                    <div>
                        <svg class="w-40 mx-auto" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="100%"
                            height="100%" viewbox="0 0 979.32677 424.8366">
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-110.33661 -237.5817)" fill="#2563eb" />
                            <path
                    ...
                    <div>
                        ...
                        <p>
                            Si necesitas mejorar algo, se te comunicará. Si
                            tu negocio digital se estanca, se te aconsejará.
                            Si fallamos en algo, lo corregiremos. Ya no
                            necesitas más motivación. Ahora necesitas
                            resultados.
                        </p>
                    </div>
                </div>
                <div class="flex flex-col justify-center gap-6 p-8 bg-white rounded shadow-sm xl:flex-row xl:gap-4">
                    <div>
                        <svg class="w-40 mx-auto" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <path
                                ...
                                transform="translate(-129 -78.76)" fill="#2563eb" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-129 -78.76)" fill="#f55f44" />
                            <path
                    ...
                    <div>
                        ...
                        <p>
                            Google valora los sitios web rápidos para el
                            posicionamiento web. Cuanto más rápidos, mejor.
                            Tu sitio web alojado en iWolf Host será más
                            rápido que el de los expertos en SEO. ¿Quieres
                            apostar algo?
                        </p>
                    </div>
                </div>
                <div class="flex flex-col justify-center gap-6 p-8 bg-white rounded shadow-sm xl:flex-row xl:gap-4">
                    <div>
                        <svg class="w-40 mx-auto" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="100%"
                            height="100%" viewbox="0 0 881.38948 697.50827">
                            <polygon
                            ...
                            <path
                                ...
                                transform="translate(-159.30526 -101.24586)" fill="#2f2e41" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-159.30526 -101.24586)" fill="#ffb9b9" />
                            <path
                                ...
                                transform="translate(-159.30526 -101.24586)" fill="#3f3d56" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-159.30526 -101.24586)" opacity="0.1" style="isolation:isolate" />
                            <polygon
                            ...
                            <path
                                ...
                                transform="translate(-159.30526 -101.24586)" fill="#2563eb" />
                            <polygon
                    ...
                    <div>
                        ...
                        <p>
                            Hay empresas con servicios más baratos, pero
                            debes leer la letra pequeña. Puedes estar
                            condenado a cumplir contratos y terminar en una
                            lista de morosos. Aquí eres libre de irte cuando
                            quieras.
                        </p>
                    </div>
                </div>
                <div class="flex flex-col justify-center gap-6 p-8 bg-white rounded shadow-sm xl:flex-row xl:gap-4">
                    <div>
                        <svg class="w-40 mx-auto" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <path
                                ...
                                transform="translate(-88.58 -43.42)" fill="#2563eb" opacity="0.1" />
                            <polygon
                            ...
                            <path d="M187,698.84s21-3.36,33.6,11.48c0,0-9.24,7.28-29.12-2.8Z"
                                transform="translate(-88.58 -43.42)" fill="#2563eb" />
                    ...
                    <div>
                        ...
                        <p>
                            Un empresario digital debería saber de
                            tecnología. Sistemas operativos, gestores de
                            contenido, software de promoción, móviles y
                            apps, hacking y seguridad online... ¿De qué
                            quieres hablar?
                        </p>
                    </div>
                </div>
        ...
        <section>
            <div class="px-8 text-center">
                <h2 class="mb-12 title">
                    El siguiente paso para emprender<br>en Internet es un sitio
                    web
                </h2>
                <p class="mb-20 text-2xl leading-relaxed">
                    <span class="block mb-2">
                        <b>Tienes tres opciones para crear tus sitios web</b>: Con nuestro constructor web profesional
                        (Alfa
                        Builder).
                    </span>
                    <span class="block mb-2">
                        Con el sitio web cuidadosamente diseñado para
                        generar múltiples fuentes de ingresos (Alfa Drupal).
                    </span>
                    Con uno de los scripts de terceros que podrás instalar
                    con un clic (Wordpress, Joomla, Moodle, etc)
                </p>
            </div>
            <div class="flex flex-col justify-between text-white bg-blue-500 md:flex-row">
                <div class="bg-blue-600 md:flex-1">
                    <div class="px-8 py-16">
                        ...
                        <ul class="arrow-right">
                            <li class="mb-6">
                                Para principiantes sin ningún tipo de
                                experiencia. Tu web en cuestión de minutos o
                                pocas horas, no en semanas o meses.
                            </li>
                            <li class="mb-6">
                                Para profesionales que buscan crear webs con
                                rapidez y elegancia para presentar sus
                                proyectos o para vender a sus propios
                                clientes.
                            </li>
                            <li class="mb-6">
                                Para todos. Desde crear efectivas páginas de
                                captura para autoresponders o atractivas
                                páginas de presentación de un producto,
                                hasta sencillas tiendas online o webs para
                                eventos.
                            </li>
                        </ul>
                        <div class="mb-12 text-sm text-center md:text-left">
                            * Incluido en todos los planes de alojamiento.
                            Plantillas limitadas en el hosting gratuito.
                        </div>
                        <div class="flex flex-col justify-between gap-6 lg:flex-row">
                            ...
                            <button class="flex-1 p-4 text-sm font-semibold text-blue-600 uppercase bg-white rounded ">
                                Probar demostración
                            </button>
                        </div>
                    </div>
                ...
                <div class="md:flex-1">
                    <div class="px-8 py-16">
                        ...
                        <ul class="arrow-right">
                            <li class="mb-6">
                                Un portal completo para trabajar a diario en
                                él y generar varias fuentes de ingresos sin
                                limitaciones. Foros, blogs, encuestas...
                            </li>
                            <li class="mb-6">
                                Optimizado milimétricamente para el
                                posicionamiento web y la velocidad. No
                                encontrarás un sitio web más rápido y
                                efectivo.
                            </li>
                            <li class="mb-6">
                                Ideal para el marketing de nichos y
                                contenidos. Perfecto para Adsense y
                                programas de afiliados. Aprende a configurar
                                uno y sabrás crear cientos de fuentes de
                                ingresos estables sin vender.
                            </li>
                        </ul>
                        <div class="mb-12 text-sm text-center md:text-left">
                            * Incluido gratis en los planes de hosting Alfa
                            y Alfa Pro. PVP por separado: $297 USD
                        </div>
                        <div class="flex flex-col justify-between gap-6 lg:flex-row">
                            <button class="flex-1 p-4 text-sm font-semibold uppercase bg-black rounded ">
                                Más información
        ...
        <section class="px-8 py-16 text-center bg-gray-100 border border-t-4 border-b-4 mb-28">
            <h2>
                Crear un sitio web como el de Apple en menos de 6 minutos
                con Alfa Site Pro
            </h2>
        </section>
        ...
        <section class="px-8 mb-24 text-center">
            <h2 class="mb-16">
                <span class="block mb-2 text-xl font-semibold subtitle">Un negocio digital está cojo sin un avanzado
                    sistema de Email Marketing</span>
            ...
            <div class="flex flex-col mb-24 shadow-2xl md:flex-row">
                <div class="px-8 pt-12 text-white bg-blue-600 rounded-t pb-14 md:rounded-l md:rounded-r-none">
                    <h3 class="mb-2 text-xl font-normal">
                        Para emprendedores digitales comprometidos en
                        realizar envíos elevados de emails
                    </h3>
                    ...
                    <div class="mb-12 text-sm text-blue-100">
                        * Incluido en el plan de hosting Alfa UNO
                    </div>
                    <button
                ...
                <div class="px-8 pt-12 text-white bg-black pb-14">
                    <h3 class="mb-2 text-xl font-normal">
                        Para emprendedores con un negocio digital en
                        constante crecimiento de suscriptores
                    </h3>
                    <div class="flex items-center justify-center mb-8 text-3xl font-bold uppercase ">
                        alfa mailer
                    ...
                    <div class="mb-12 text-sm text-blue-100">
                        * Incluido en el plan de hosting Alfa DOS
                    </div>
                    <button
                ...
                <div class="px-8 pt-12 text-white bg-gray-500 rounded-b pb-14 md:rounded-r md:rounded-l-none">
                    <h3 class="mb-2 text-xl font-normal">
                        Para emprendedores que aún están empezando a crear
                        su lista de email marketing
                    </h3>
                    <div class="flex items-center justify-center mb-8 text-3xl font-bold uppercase ">
                        alfa mailer
                        <span class="px-0 ml-2 text-sm font-medium leading-4 text-black bg-white rounded ">tres</span>
                    </div>
                    <div class="p-4 text-6xl font-bold border-2 rounded-t">
                    ...
                    <div class="mb-12 text-sm text-blue-100">
                        * Incluido en el plan de hosting Alfa TRES
                    </div>
                    <button
            ...
            <div class="grid gap-16 mb-16 text-left md:grid-cols-2">
                <div class="flex items-start gap-3 md:gap-4">
                    <div class="w-32 md:w-20 h-20 mt-0.5 text-sky-500">
                        <svg data-icon="check-circle" role="img" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div>
                        <h3 class="mb-2 font-semibold">
                            Constructor de emails adaptativos
                        </h3>
                        <p>
                            Solo arrastrando y soltando elementos puedes
                            crear emails y promociones que se adaptan a
                ...
                <div class="flex items-start gap-3 md:gap-4">
                    ...
                    <div>
                        ...
                        <p>
                            El visitante se suscribe a tu lista de contactos
                            y comienza a recibir automáticamente mensajes,
                            promociones y artículos de tu blog. Efectivo.
                        </p>
                    </div>
                </div>
                <div class="flex items-start gap-3 md:gap-4">
                    ...
                    <div>
                        <h3 class="mb-2 font-semibold">
                            Gráficas profesionales de seguimiento
                        </h3>
                        <p>
                            Sabrás quién ha abierto tus emails, desde qué
                            país, en qué enlaces han hecho clic, porcentaje
                            de aperturas, cancelaciones... Indispensable.
                        </p>
                    </div>
                </div>
                <div class="flex items-start gap-3 md:gap-4">
                    ...
                    <div>
                        <h3 class="mb-2 font-semibold">
                            Plantillas de emails prediseñadas
                        </h3>
                        <p>
                            Tienes cientos de emails con imágenes y estilos
                            prediseñados para que solamente tengas que
                ...
                <div class="flex items-start gap-3 md:gap-4">
                    ...
                    <div>
                        <h3 class="mb-2 font-semibold">
                            Importación de listas de contactos
                        </h3>
                        <p>
                            Puedes importar tus contactos e incluirlos para
                            recibir los emails de tu negocio cumpliendo con
                            la Ley CAN-SPAM. No empieces desde cero.
                        </p>
                    </div>
                </div>
                <div class="flex items-start gap-3 md:gap-4">
                    ...
                    <div>
                        ...
                        <p>
                            Un suscriptor no abre uno de tus emails. Se
                            añade automáticamente a un segmento para volver
                            a enviarle el email. Todo automatizado.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="px-8 mb-16 text-center">
            <h2>Empresarios digitales</h2>
        </section>
        ...
        <section class="px-8 pt-20 pb-24 mb-24 bg-gray-200 services">
            ...
            <p class="mb-16 text-2xl leading-relaxed text-center">No te compliques la vida. Delega en personal
                cualificado las tareas técnicas vitales y necesarias para mantener tu sitio web y hacer crecer tu
                negocio digital mientras tú te enfocas en atender a tus nuevos clientes, crear nuevos productos, mejorar
                tus servicios y rentabilizar tu negocio en Internet</p>
            <div class="h-0"></div>
            <ul id="tabs"
                ...
                <li class="flex-wrap md:w-1/3">
                    <a href="#tabs" id="seotab" class="block p-4 bg-blue-600 rounded active tab hover:bg-blue-600">
            ...
            <div id="seotabcontent" class="flex flex-col items-end gap-8 p-12 bg-white rounded shadow-sm lg:flex-row">
                <div class="w-full lg:w-1/3">
                    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"
                        ...
                        <path
                            ...
                            transform="translate(-181.36642 -141.74228)" fill="#2563eb" />
                        <path
                ...
                <div class="lg:w-2/3">
                    <h2 class="mb-8 text-3xl font-medium leading-10 normal-case ">
                        El marketing en buscadores es crítico. O lo haces tú o
                        puedes incluirnos en tu equipo para hacerlo nosotros
                    </h2>
                    <p class="mb-4">
                        Intentar posicionar tus páginas web de forma incorrecta
                        y precaria te hará perder meses de trabajo sin ver
                        resultados. Delegar en personas inadecuadas te
                        penalizará y te hará perder dinero destruyendo el
                        trabajo que hubieras podido hacer bien. Y pagar en
                        Google Adwords podría arruinar tu presupuesto.
                    </p>
                    <p class="mb-8">
                        El posicionamiento web llevará tu negocio digital a la
                        cumbre y podemos ayudarte a conseguirlo.
                    </p>
                    <a href="#"
            ...
            <div id="socialtabcontent"
                ...
                <div class="w-full lg:w-1/3">
                    <svg id="ad1db818-b740-459f-8c8c-b7c337b4c82d" data-name="Layer 1"
                        ...
                        <path
                            ...
                            transform="translate(-59 -184.58065)" fill="#e6e6e6" />
                        <path
                        ...
                        <path id="e84b1720-bcff-4cbb-a054-3015ec64150f" data-name="Path 40"
                            ...
                            transform="translate(-59 -184.58065)" fill="#3f3d56" />
                        <path id="e860648b-2b37-4627-9c5b-8f6e964a3c31" data-name="Path 40"
                            ...
                            transform="translate(-59 -184.58065)" fill="#2563eb" />
                        ...
                        <path
                            ...
                            transform="translate(-59 -184.58065)" fill="#a0616a" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-59 -184.58065)" fill="#2f2e41" />
                        <path
                        ...
                        <polygon points="853.993 274.202 879.98 270.849 869.92 239.832 844.771 239.832 853.993 274.202"
                            fill="#a0616a" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-59 -184.58065)" fill="#fff" />
                        <polygon points="829.051 264.596 819.854 273.267 797.978 251.655 809.08 244.428 829.051 264.596"
                            fill="#2563eb" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-59 -184.58065)" opacity="0.2" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-59 -184.58065)" fill="#ffb9b9" />
                        <path
                ...
                <div class="lg:w-2/3">
                    ...
                    <p class="mb-8">
                        Las redes sociales no son para vender, son para socializar, para conocer a tu audiencia, para
                        difundir contenido relacionado con tu mercado y conseguir la interacción de tus clientes
                        potenciales. Necesitas analizar sus intereses, su procedencia, sus inquietudes, su género, su
                        edad, sus horarios de conexión. Podemos ayudarte a conseguir más seguidores y proporcionarles
                        contenido que puedan compartir para difundir mejor la marca de tu negocio digital.
                    </p>
                    <a href="#"
                        class="inline-block px-4 py-2 text-center text-blue-700 uppercase border-2 border-blue-700 rounded ">Infórmate
                        sobre los planes disponibles
            ...
            <div id="designtabcontent"
                class="flex flex-col items-end hidden gap-8 p-12 bg-white rounded shadow-sm lg:flex-row">
                <div class="w-full lg:w-1/3">
                    <svg id="aab721b6-4aa1-4d02-a3e3-167256aa258c" data-name="Layer 1"
                        ...
                        <path
                            ...
                            transform="translate(-110 -205.25977)" fill="#2563eb" />
                ...
                <div class="lg:w-2/3">
                    ...
                    <p class="mb-8">
                        ...
                        labores de mantenimiento en tu sitio web, en el corazón de tu negocio digital. También querrás o
                        necesitarás ampliar sus funciones, por ejemplo, añadiendo foros o sistemas de tickets
                        completamente integrados con tu diseño. Podemos encargarnos de esas tareas tan monótonas y,
                        muchas veces, problemáticas de tu web.
                    </p>
                    <a href="#"
                        class="inline-block px-4 py-2 text-center text-blue-700 uppercase border-2 border-blue-700 rounded ">Infórmate
                        sobre los planes disponibles
        ...
        <section class="flex flex-col items-center gap-8 px-8 mb-24 apps lg:flex-row">
            <div class="w-full lg:w-1/3">
                <svg class="w-full h-full justify" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path d="M506.5,377.4873h-188v-153h188Zm-186-2h184v-149h-184Z" transform="translate(-214 -71.86704)"
                        fill="#3f3d56"></path>
                    ...
                    <path d="M760.5,283.9873h-182v-18h182Zm-180-2h178v-14h-178Z" transform="translate(-214 -71.86704)"
                        fill="#3f3d56"></path>
                    <path d="M835.5,326.9873h-257v-18h257Zm-255-2h253v-14h-253Z" transform="translate(-214 -71.86704)"
                        fill="#3f3d56"></path>
                    <path d="M835.5,439.4873h-517v-18h517Zm-515-2h513v-14h-513Z" transform="translate(-214 -71.86704)"
                        fill="#3f3d56"></path>
                    <rect x="118.5" y="409.62024" width="515" height="16" fill="#f2f2f2"></rect>
                    <path d="M835.5,489.4873h-517v-18h517Zm-515-2h513v-14h-513Z" transform="translate(-214 -71.86704)"
                        fill="#3f3d56"></path>
                    <rect x="118.5" y="459.62024" width="515" height="16" fill="#f2f2f2"></rect>
                    <path d="M835.5,539.4873h-517v-18h517Zm-515-2h513v-14h-513Z" transform="translate(-214 -71.86704)"
                        fill="#3f3d56"></path>
                    <rect x="118.5" y="509.62024" width="515" height="16" fill="#f2f2f2"></rect>
                    <path d="M835.5,589.4873h-517v-18h517Zm-515-2h513v-14h-513Z" transform="translate(-214 -71.86704)"
                        fill="#3f3d56"></path>
                    <rect x="118.5" y="559.62024" width="515" height="16" fill="#f2f2f2"></rect>
                    <path d="M835.5,639.4873h-517v-18h517Zm-515-2h513v-14h-513Z" transform="translate(-214 -71.86704)"
                        fill="#3f3d56"></path>
                    <rect x="118.5" y="609.62024" width="515" height="16" fill="#f2f2f2"></rect>
                    <path d="M835.5,689.4873h-517v-18h517Zm-515-2h513v-14h-513Z" transform="translate(-214 -71.86704)"
                        fill="#3f3d56"></path>
                    ...
                    <path
                        ...
                        transform="translate(-214 -71.86704)" fill="url(#a026aeeb-1716-483c-ac60-35ab5f709f89)"></path>
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-214 -71.86704)" fill="#3f3d56"></path>
                    <path d="M257.60492,372.85474a5.2478,5.2478,0,0,0,1.962.73042,6.32546,6.32546,0,0,0,5.23383-.78428Z"
                        transform="translate(-214 -71.86704)" opacity="0.1"></path>
                </svg>

            </div>
            <div class="text-center lg:w-2/3">
                <h2 class="mb-16 text-4xl font-medium">397 aplicaciones web para tu negocio digital, con sólo un clic
                </h2>
                <div
                    class="grid grid-cols-2 sm:grid-cols-3 mb-8 gap-x-16 gap-y-8 cms-logos justify-items-center place-items-center">
                    <div>
                        <svg class="w-full h-full" version="1.1" id="prefix__layer" xmlns="http://www.w3.org/2000/svg"
                            x="0" y="0" viewbox="0 0 551.3 128.7" xml:space="preserve">
                            <style>
                                .prefix__st0 {
                                    fill: #0678be
                                }
                    ...
                    <div>
                        <svg class="w-full h-full" xmlns="http://www.w3.org/2000/svg" width="540" height="123"
                            ...
                            <path
                                ...
                                class="b" />
                            <path d="M8.7 61.3c0 20.8 12.1 38.8 29.6 47.3L13.3 39.9C10.3 46.4 8.7 53.6 8.7 61.3z"
                                class="b" />
                            <path
                    ...
                    <div>
                        <svg class="w-full h-full" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414"
                            viewbox="0 0 381 79" xmlns="http://www.w3.org/2000/svg">
                            <g fill="#3b3a40">
                                <path
                    ...
                    <div>
                        <svg class="w-full h-full" viewbox="0 0 714.636 118.299">
                            ...
                            <path fill="#AA9678" d="M83.038 104.757h-.105l.11.078c-.002-.026-.005-.051-.005-.078z" />
                            <path fill="#AA9678"
                            ...
                            <g>
                                ...
                                <path fill="none" d="M61.891 42.373v.243" />
                                <path
                    ...
                    <div>
                        <svg class="w-full h-full" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 3316 915.7">
                            <g data-name="Logo">
                                <path fill="#f26322"
                ...
                <div class="text-xl">Foros, comunidades, tickets de soporte, chats en vivo, anuncios clasificados...
        ...
        <section class="grid gap-12 px-8 pt-20 pb-24 bg-gray-200 faqs md:grid-cols-2">
            <article>
                ...
                <div class="overflow-hidden bg-white rounded shadow-sm card p-2">
                    <img src="https://picsum.photos/id/1/600/400" class="rounded-sm" alt="" width="600" height="400">
                    <div class="py-8 px-7 card-body">
                        ...
                        <div>Pariatur mollit dolor ut deserunt qui ex mollit esse officia. Sunt ut cupidatat ad ea.
                            ...
                            exercitation consequat ut consectetur ut sunt duis qui culpa occaecat dolore magna.</div>
                    </div>
                </div>
            </article>
            <article>
                ...
                <ul class="flex flex-col gap-8">
                    <li>
                        <h4 class="text-xl font-medium"><a
                                ...
                                href="#"><span class="w-full">Culpa dolor magna reprehenderit consectetur duis occaecat
                                    cillum</span><span
                        ...
                        <div class="visible mt-2 font-normal answer">
                            ...
                            exercitation consequat eu. Anim ut irure et quis laboris laboris Lorem culpa et adipisicing
                            amet.
                        </div>
                    </li>
                    <li>
                        <h4 class="text-xl font-medium"><a
                                ...
                                href="#"><span class="w-full">Incididunt incididunt et in reprehenderit quis occaecat
                                    velit proident.</span><span
                        ...
                        <div class="invisible h-0 font-normal answer">
                            ...
                            Veniam ex nisi ad cillum dolor qui. Amet anim cupidatat aliquip ex. Duis esse voluptate qui
                            voluptate minim est culpa. Cillum fugiat et duis velit. Ipsum consequat occaecat culpa
                    ...
                    <li>
                        ...
                        <div class="invisible h-0 font-normal answer">
                            ...
                            enim. Pariatur do fugiat elit ullamco occaecat do. Eiusmod adipisicing exercitation commodo
                            do. Cillum aliqua cupidatat reprehenderit duis elit.
                        </div>
                    </li>
                    <li>
                        <h4 class="text-xl font-medium"><a
                                class="flex items-center justify-between gap-4 text-blue-600 hover:text-black"
                                href="#"><span class="w-full">Culpa magna tempor cillum dolor amet id duis esse pariatur
                                    reprehenderit ex.</span><span
                                    class="flex items-center justify-center w-6 h-6 font-light text-white bg-black rounded">+</span></a>
                        </h4>
                        <div class="invisible h-0 font-normal answer">
        ...
        <div class="items-center justify-center gap-8 p-8 news md:flex">
            ...
            <div class="">
                <p class="mb-4 text-center text-white">
                    Recibe gratis por email trucos y consejos para hacer
                ...
                <form class="inline-flex justify-around w-full gap-2" action="#">
                    ...
                    <button class="w-full p-3 text-white uppercase bg-black rounded ">
                        suscribirse
                    </button>
                </form>
            </div>
            ...
            <div class="grid grid-cols-1 gap-8 text-white md:grid-cols-3 md:w-5/6">
                ...
                <section id="social">
                    ...
                    <p class="mb-6 text-sm text-white">
                        Mantente al día de la actualidad de iWolf Host
                        siguiéndonos en las redes sociales y uniéndote a
                        nuestra comunidad.
                    </p>
    ...
    <div class="items-center justify-between p-8 text-center md:text-left md:flex">
        <p class="text-sm text-gray-500">
            The Alfa Host LLC, 201 East 5th St. STE 1200, Sheridan, WY,
            82801, Estados Unidos<br />
            Copyright © 2012-2021 www.alfa.host - Todos los Derechos
            Reservados
        </p>
    ...
    <a href="#" id="totop" class="fixed hidden bottom-4 right-4 opacity-30 hover:opacity-50">
        <svg aria-hidden="true" focusable="false" class="w-8" role="img" xmlns="http://www.w3.org/2000/svg"
            viewbox="0 0 512 512">
            <path fill="currentColor"

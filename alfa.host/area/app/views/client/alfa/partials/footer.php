<footer class="relative bg-blue-600 bg-[url('../images/free-wolf.webp')] bg-bottom bg-cover md:bg-auto 2xl:bg-cover shadow-[0_-50px_50px] shadow-slate-200 -z-10 border-t border-white

<div class="flex items-center gap-2 relative">
    <?php if ((isset($logged_in) ? $logged_in : null)): ?>
        <button class="nav-link btn-outline border-white text-white [&_svg]:fill-white hover:border-white hover:text-white hover:bg-white/10 [anchor-name:--user-menu-btn]" popovertarget="user-menu">

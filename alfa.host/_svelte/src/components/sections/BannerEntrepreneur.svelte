...
>
	...
	<h2 class="flex flex-col w-full gap-2 text-2xl text-right uppercase md:gap-5 md:text-4xl">
		<span class="block"
			><b class="py-1 pl-2 pr-8 font-bold text-white bg-black bg-opacity-80 md:pr-8"
				>Convertir emprendedores</b
			></span
		>
		<span class="block"
			><b class="py-1 pl-2 pr-8 font-bold text-white bg-black bg-opacity-80 md:pr-8"
				>en empresarios digitales</b
			></span
		>
		<span class="block"
			><b class="py-1 pl-2 pr-8 font-bold text-white bg-black bg-opacity-80 md:pr-8"
				>es el principal objetivo</b
			></span
		>
	</h2>
</section>

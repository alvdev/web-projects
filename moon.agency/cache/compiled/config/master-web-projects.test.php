...
return [
    ...
    'timestamp' => 1670174388,
    'checksum' => '359e33be724b85e2845f1207c83533e0',
    'files' => [
        'user/web-projects.test/config' => [
            'flex/pages' => [
                'file' => 'user/web-projects.test/config/flex/pages.yaml',
                'modified' => 1668977189
            ],
            'plugins/admin' => [
                'file' => 'user/web-projects.test/config/plugins/admin.yaml',
                'modified' => 1669482958
            ],
            'plugins/antispam' => [
                'file' => 'user/web-projects.test/config/plugins/antispam.yaml',
                'modified' => 1669922795
            ],
            'plugins/photoswipe' => [
                'file' => 'user/web-projects.test/config/plugins/photoswipe.yaml',
                'modified' => 1669203439
            ],
            'plugins/unitegallery' => [
                'file' => 'user/web-projects.test/config/plugins/unitegallery.yaml',
                'modified' => 1669072948
            ],
            'plugins/webp' => [
                'file' => 'user/web-projects.test/config/plugins/webp.yaml',
                'modified' => 1669205046
            ],
            'security' => [
                'file' => 'user/web-projects.test/config/security.yaml',
                'modified' => 1668977189
            ],
            'site' => [
                'file' => 'user/web-projects.test/config/site.yaml',
                'modified' => 1670169324
            ],
            'system' => [
                'file' => 'user/web-projects.test/config/system.yaml',
                'modified' => 1670169349
            ],
            'themes/moon' => [
                'file' => 'user/web-projects.test/config/themes/moon.yaml',
                'modified' => 1670174388
            ]
        ],
        'user/config' => [
            ...
            'themes/moon' => [
                'file' => 'user/config/themes/moon.yaml',
                'modified' => 1668973824
            ],
            'themes/receptar' => [
        ...
        'user/plugins' => [
            ...
            'plugins/photoswipe' => [
                'file' => 'user/plugins/photoswipe/photoswipe.yaml',
                'modified' => 1669202308
            ],
            'plugins/problems' => [
        ...
        'user/themes' => [
            'themes/akazie-wood' => [
                'file' => 'user/themes/akazie-wood/akazie-wood.yaml',
                'modified' => 1669074213
            ],
            'themes/moon' => [
                'file' => 'user/themes/moon/moon.yaml',
                'modified' => 1668962298
            ],
            'themes/receptar' => [
                'file' => 'user/themes/receptar/receptar.yaml',
                'modified' => 1665250846
            ]
        ]
    ],
...
3000 Bern',
                ...
                'style' => [
                    ...
                    'fonts' => [
                        'import' => 'https://fonts.googleapis.com/css?family=Montserrat|Open+Sans|Raleway&display=swap',
            ...
            'moon' => [
                ...
                'email' => 'contacto@moonagency.net',
                'phone' => '34910000000',
                'address' => 'C/ Madrid 00, Madrid, 28000',
                'info' => 'Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl uekt aliquip ex ea commodo consequat duis auhtem.',
                'slogan' => 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius eligendi maiores assumenda, cumque soluta error.',
                'about_us' => '#### La luna está llena de secretos y de historias que no se pueden contar.

Los llaman inadaptados a los que deciden romper las reglas de experimentar escenas prohibidas para mentes cerrads.

Pecado debería de ser no disfrutar de pequeños placeres de la vida.

¿Una copa de buen vino? ¿Un whisky sin hielo? ¿O polvos mágicos?

#### ¿Algo más atrevido? ¡Ufff!

Te declaras culpable al no poder resistirte a esas siluetas que quitan el aliento con la belleza y sensualidad de esos movimientos. Camina semidesnuda y con ganas de descubrir cada parte de su cuerpo.

**Prohibido debería de ser no hacer lo que la gente dice que no puedes hacer**.',
                'our_services' => '### Servicio 1
Airmod tempor invidunt ut labore et dolore magna aliquyam erat
...
Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed',
                'test' => '',
                'testimonials' => 'At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa'
            ],
            'receptar' => [
                'enabled' => true,
                'showchildpages' => [
...
node_modules'
        ...
        'site' => [
            ...
            'metadata' => [
                'description' => 'Moon Agency is a minimal model agency theme'
            ],
            'summary' => [
                'enabled' => true,
                'format' => 'short',
            ...
            'social' => [
                0 => [
                    'text' => 'facebook',
                    'url' => 'http://www.facebook.com/alvdev'
                ],
                1 => [
                    'text' => 'twitter',
                    'url' => 'http://www.twitter.com/alvdev'
                ],
                2 => [
                    'text' => 'linkedin',
                    'url' => 'http://www.linkedin.com/alvdev'
                ],
                3 => [
                    'text' => 'youtube-play',
                    'url' => 'http://www.youtube.com/alvdev'
                ],
                4 => [
                    'text' => 'home',
                    'url' => '/'
            ...
            'copyright' => '<div class="legal"><a href="#" id="about-textos-legales#terminosCondiciones">Textos Legales</a><a href="#" id="about-textos-legales#politicaPrivacidad">Política Privacidad</a><a href="#" id="about-textos-legales#cookies">Cookies</a><a href="#" id="about-textos-legales#1_4_4">USC 2257</a><a href="#" id="about-contactar">Contactar</a></div><div class="site-ccards"><img class="logo_visa" src="https://alv.dev/demo/005/user/themes/receptar/images/pagovisanew.png" alt="VISA"><img class="logo_visaelectron" src="https://alv.dev/demo/005/user/themes/receptar/images/pagovisaelectronnew.png" alt="VISA Electron"><img class="logo_mastercard" src="https://alv.dev/demo/005/user/themes/receptar/images/pagomastercardnew.png" alt="MasterCard"><img class="logo_maestrocard" src="https://alv.dev/demo/005/user/themes/receptar/images/pagomaestrocardnew.png" alt="Maestro"></div>'
        ],
        'system' => [
            'absolute_urls' => false,
            'timezone' => NULL,

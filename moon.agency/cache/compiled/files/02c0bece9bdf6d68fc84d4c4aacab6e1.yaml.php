...
return [
    ...
    'filename' => 'C:/wamp/www/web-projects/moon.agency/user/plugins/photoswipe/languages.yaml',
    'modified' => 1669202308,
    'size' => 3915,
    'data' => [
        'en' => [
            'PLUGIN_PHOTOSWIPE' => [
                ...
                'OPTIONS' => [
                    ...
                    'PINCH_TO_CLOSE' => [
                        ...
                        'HELP' => 'Pinch to close gallery gesture. The gallery’s background will gradually fade out as the user zooms out. When the gesture is complete, the gallery will close.'
                    ],
                    'CLOSE_ON_SCROLL' => [
                ...
                'LOADING_ERROR' => '[The image] could not be loaded'
            ]
        ]
    ]
];

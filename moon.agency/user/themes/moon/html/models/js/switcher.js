...
jQuery(document).ready(function () {
  ...
  switcherHTML +=
    '<div class="color_switcher_header"><h4>Selector de color</h4>';
  ...
  switcherHTML += '<p>Color:</p>';
  switcherHTML += '<ul id="switcher-version" class="list-inline">';
  switcherHTML += '<li class="active">';
  switcherHTML += '<a href="#" class="dark">Oscuro</a>';
  switcherHTML += '</li>';
  switcherHTML += '<li>';
  switcherHTML += '<a href="#" class="light">Claro</a>';
  switcherHTML += '</li>';
  switcherHTML += '</ul>';
  switcherHTML += '</div>';

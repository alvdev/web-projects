...
JSCODE;
    ...
    public function onAssetsInitialized()
    {
        ...
        $this->grav['assets']->addJs("https://www.googletagmanager.com/gtag/js?id={$trackingId}", ['priority' => 9, 'pipeline' => true, 'loading' => 'async', 'group' => 'head', 'type' => 'text/partytown']);
        $this->grav['assets']->addInlineJs($code, ['inline' => null, 'group' => 'head', 'type' => 'text/partytown']);
    }
}

...
function uuleEncode(lat, lng) {
  ...
  view.setUint32(0, 184551424, true);
...
document.addEventListener("alpine:init", () => {
  module_default.data("searchForm", () => ({
    keyword: "",
    countryQuery: "",
    ...
    async geocodeAddress() {
      ...
      this.geoError = "";
      try {
        const res = await fetch(`https://maps.googleapis.com/maps/api/geocode/json?address=${encodeURIComponent(this.address)}&key=${window.mapsApiKey}`);

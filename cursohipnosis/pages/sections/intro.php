<section id="intro" class="container mt-16 md:mt-24 lg:mt-36 scroll-mt-84">
...
<section class="container mt-24 md:mt-36 lg:mt-42">
    <div class="text-center">
        <h2 class="mb-8 text-4xl md:text-5xl">¿<span class="font-bold">Quién te enseñará</span> la terapia de hipnosis?</h2>
